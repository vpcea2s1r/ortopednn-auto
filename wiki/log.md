...
## [2026-08-25] create | Волна C: protez-vypadaet (7.6k) + shataetsya-koronka-na-implante (6.8k)
Спрос: «что делать если протез выпадает при еде», «почему не держится верхний протез»,
«коронка на импланте шатается в чем причина» x2. Live 200, deploy success (4652441).
Сайт: 426 страниц.

## [2026-08-25] create | Волна D: verhniy-protez-na-prisoskah (5.4k) + pochemu-natiraet (5.6k)
Спрос: «протез на присосках», «почему натирает зубной протез». Live, deploy success.
Сайт: 428 страниц. Очередь: расширение D до 7k при следующей итерации.
