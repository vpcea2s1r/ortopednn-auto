...
function getDgramOverrides({
  ...
  const enabledByFlag = compatibilityFlags.includes("enable_nodejs_dgram_module") && compatibilityFlags.includes("experimental");
  const enabled = enabledByFlag && !disabledByFlag;
  return enabled ? {
    nativeModules: ["dgram"],
    hybridModules: []
...
function getStreamWrapOverrides({
  ...
  const enabledByFlag = compatibilityFlags.includes("enable_nodejs_stream_wrap_module") && compatibilityFlags.includes("experimental");
  const enabled = enabledByFlag && !disabledByFlag;
  return enabled ? {
