...
<p class="lead">Когда зубы стираются быстрее нормы — это не только эстетика. Патологическая стираемость меняет прикус, снижает высоту лица, вызывает боль в суставе. Проблема встречается всё чаще, и уже не только у пожилых: стираемость диагностируют у пациентов 25–40 лет.</p>
      ...
      <h2>Код по МКБ: K03.0</h2>

      <p>В карте патологическая стираемость идёт под кодом K03.0 — повышенное стирание зубов. Рядом кодируют причину: бруксизм, прикус, профвредности. Код нужен для направлений, квот и ДМС. Подробнее о кодах диагнозов — в статье <a href="/blog/mkb-v-stomatologii/">«коды МКБ в стоматологии»</a>.</p>
