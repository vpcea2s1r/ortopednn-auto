...
<h1>Больно ли ставить коронку на зуб</h1>
      ...
      <p>Нет. Временную коронку не обтачивают и фиксируют на слабый цемент — процедура занимает 5–10 минут и не требует анестезии. Лёгкое давление при надавливании — единственное ощущение, которое можно заметить.</p>
