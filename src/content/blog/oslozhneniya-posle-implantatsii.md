...
---
      ...
      <p><strong>Отторжение импланта.</strong> Имплант не прижился или потерял интеграцию с костью. Причины: недостаточный объём кости, перегрузка, инфекция, курение. Симптомы — подвижность импланта, боль при накусывании. Что делать в такой ситуации — в статьях <a href="/blog/implant-ne-prizhilsya/">«имплант не прижился»</a> и <a href="/blog/bolit-posle-implantacii/">«болит после имплантации»</a>.</p>
      ...
      <p>Умеренная боль после установки импланта длится 2–3 дня, снимается ибупрофеном или кеторолаком. Сильная боль дольше трёх дней, не поддающаяся таблеткам, — повод срочного осмотра для исключения воспаления или перегрузки конструкции.</p>
      </div>
      <div class="faq-item">
