...
**Эксперимент завершён 2026-08-15.** Все 10 статей расширены до 7.2–9.3k знаков (среднее ~8.3k, было ~4.6k), опубликованы в один день. Метрика: сравнить Yandex searchable-индекс (было 59 на 15.08.2026, стало 342 на 24.09.2026) и позиции по GSC. Прочие находки: у `bolit-chelyust-posle-protezirovaniya` не было записи в `data/blog-articles.ts` — добавлена.
...
12. **ОМС-контент не пишем (решение 2026-09-24)** — топ спроса по Вебмастеру (1008 запросов/нед) это ОМС/бесплатно, но интент некоммерческий, конверсий не даст. Коммерческие темы из того же спроса: сэндвич-протезы, телескопические коронки, уход/цвет
